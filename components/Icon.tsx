...
const STROKE = {
  ...
  snap:
    "M12 3c-2.8 0-4.8 2.1-4.8 4.9v2.6l-1.9-.5c-.5 0-.8.6-.3.9l2 1c-.6 1.6-1.8 2.9-3.5 3.5.5.8 1.5 1 2.5 1.2.2.6.4 1.3 1 1.3.8 0 1.7-.5 3.3.3.7.4 1.1.8 1.7.8s1-.4 1.7-.8c1.6-.8 2.5-.3 3.3-.3.6 0 .8-.7 1-1.3 1-.2 2-.4 2.5-1.2-1.7-.6-2.9-1.9-3.5-3.5l2-1c.5-.3.2-.9-.3-.9l-1.9.5V7.9C16.8 5.1 14.8 3 12 3z",
