 ...
 * seed, with its made-up demo catalogue, against the dedicated e2e database
 * (the seed empties it first).
 *
...
execSync("npx tsx prisma/seed.ts", {
  cwd,
  env: { ...env, UPLOAD_DIR: "./storage/e2e-uploads", SEED_DEMO_CATALOG: "1" },
  stdio: "pipe",
});
